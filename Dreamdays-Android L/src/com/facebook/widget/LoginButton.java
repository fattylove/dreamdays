...
//        parseAttributes(attrs);
    ...
    private void setButtonText() {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
            //setText((logoutText != null) ? logoutText : getResources().getString(R.string.com_facebook_loginview_log_out_button));
//            setText((logoutText != null) ? logoutText : getResources().getString(R.string.com_facebook_loginview_log_in_button));
        } else {
