...
public class DreamdaysWidgetNext extends AppWidgetProvider {
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,int[] appWidgetIds) {
		...
		ComponentName cmpName = new ComponentName(context,DreamdaysWidgetNext.class);
	...
	private static Matter getMatter(Context context) {
		ArrayList<Matter> matterList =ALDetailActivity.sortMatters((ArrayList<Matter>) new MatterService().queryMatterByCategory(context, 0)) ;
